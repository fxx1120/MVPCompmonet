...
import com.fxx.component.main.di.component.DaggerMainCommonOrientationWebViewComponent;
...
import com.fxx.component.main.mvp.presenter.MainCommonOrientationWebViewPresenter;
...
public class MainCommonOrientationWebViewActivity extends BaseActivity<MainCommonOrientationWebViewPresenter> implements MainCommonOrientationWebViewContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerMainCommonOrientationWebViewComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .mainCommonOrientationWebViewModule(new MainCommonOrientationWebViewModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.main_activity_main_common_orientation_web_view; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
...
//                ArmsUtils.snackbarText("onPageStarted");
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                userInfoBean.setAccess_token(DataHelper.getStringSF(MainCommonOrientationWebViewActivity.this, Constant.COMMON_TOKEN));
                userInfoBean.setExtend_id(DataHelper.getStringSF(MainCommonOrientationWebViewActivity.this, Constant.COMMON_IDENTITY_ID));
                userInfoBean.setType(DataHelper.getStringSF(MainCommonOrientationWebViewActivity.this, Constant.COMMON_IDENTITY));
